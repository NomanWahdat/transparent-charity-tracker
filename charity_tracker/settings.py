"""
Django settings for charity_tracker project.
...
BLOCKCHAIN_NETWORK = config('BLOCKCHAIN_NETWORK', default='ethereum')
WEB3_PROVIDER_URL = config('WEB3_PROVIDER_URL', default='http://localhost:8545')
SMART_CONTRACT_ADDRESS = config('SMART_CONTRACT_ADDRESS', default='')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@transparentcharity.com')
...
PRICE_VARIANCE_WARNING_PERCENT = 20  # Flag items 20% above market price
